...
####[ REQUIRED VARIABLES ]####
LOGGER = str('doctormike')
OUTPUT_PATH = str(pytubefix.helpers.target_directory('/opt/media/tv.docs/Doctor Mike (2017) {tvdb-359268}'))
SERIES_PREFIX = str('Doctor Mike (2017) - ')
YOUTUBE_URL = str('https://www.youtube.com/@DoctorMike/videos')
SECTION_ID = str('6')
...
def main():
    ...
    for index, VID in enumerate(x.videos, start=1):
        ...
        pattern = r'(Reacts To|Compilation)'
