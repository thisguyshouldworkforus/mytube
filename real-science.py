...
####[ REQUIRED VARIABLES ]####
LOGGER = str('real-science')
OUTPUT_PATH = str(pytubefix.helpers.target_directory('/opt/media/tv.docs/Real Science (2020) {tvdb-xxxxx}'))
SERIES_PREFIX = str('Real Science (2020) - ')
YOUTUBE_URL = str('https://www.youtube.com/@realscience/videos')
SECTION_ID = str('6')
SERIES_URL = str('http://plex.int.snyderfamily.co:32400/web/index.html#!/server/50d6b668401e93d23054d59158dfff33bc988de4/details?key=%2Flibrary%2Fmetadata%2F54633&context=source%3Acontent.library~0~0')
PLAYLIST = False
CHANNEL = True
INITIALIZE = False
####[ REQUIRED VARIABLES ]####
