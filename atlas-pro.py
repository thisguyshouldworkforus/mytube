...
####[ REQUIRED VARIABLES ]####
LOGGER = str('atlas')
OUTPUT_PATH = str(pytubefix.helpers.target_directory('/opt/media/tv.docs/Atlas Pro (2018) {tvdb-000000}'))
SERIES_PREFIX = str('Atlas Pro (2018) - ')
YOUTUBE_URL = str('https://www.youtube.com/@AtlasPro1/videos')
SECTION_ID = str('6')
SERIES_URL = str('http://plex.int.snyderfamily.co:32400/web/index.html#!/server/50d6b668401e93d23054d59158dfff33bc988de4/details?key=%2Flibrary%2Fmetadata%2F40729&context=source%3Acontent.library~0~4')
PLAYLIST = False
CHANNEL = True
INITIALIZE = False
####[ REQUIRED VARIABLES ]####
